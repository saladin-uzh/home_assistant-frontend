...
describe('relativeTime', () => {
  ...
  describe('2 minute difference', () => {
    ...
    it('without tense', () => {
      assert.strictEqual(relativeTime(date1, locale, date2, false), '2 minutes')

      assert.strictEqual(relativeTime(date2, locale, date1, false), '2 minutes')
    })
  })
  ...
  describe('11 month difference during same year', () => {
    ...
    it('without tense', () => {
      assert.strictEqual(relativeTime(date1, locale, date2, false), '11 months')

      assert.strictEqual(relativeTime(date2, locale, date1, false), '11 months')
    })
  })
